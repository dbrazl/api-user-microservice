...
class IndexUsersFactory(IndexUsersFactoryInterface):
  ...
  def __init__(
    ...
    index_users_by_name_use_case: IndexUsersByNameUseCaseInterface,
    ...
    self.index_users_by_name_use_case = index_users_by_name_use_case
  ...
  def make_index_use_case(self, filter: str) -> IndexUserByIdUseCaseInterface | IndexUserByEmailUseCaseInterface | IndexUsersUseCaseInterface:
    match filter:
      ...
      case 'name':
        return self.index_users_by_name_use_case
